...
export default function SchoolCalendar() {
  ...
  const startDateForGrid = new Date(
    currentYear,
    currentMonth,
    1 - startDayOfWeek
  );
      ...
      <div className="flex flex-row items-center justify-between p-4">
        ...
        <div className="flex items-center text-gray-600 space-x-2">
          <select
            ...
            className="bg-white rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
          ...
          <button
            ...
            className="text-sm font-medium rounded-md hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
            &lt;
          </button>
